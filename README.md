...
O jogo integra conceitos de ambas as áreas, combinando fundamentos de **lógica proposicional** e **programação em C** para criar uma experiência interativa que aplica raciocínio lógico, estruturas de controle e modularização de forma prática.
